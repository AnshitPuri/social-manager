  ...
  const features = [
    {
      ...
      title: "Analyze",
      description:
        "Get deep insights from your posts and engagement metrics. Understand what works.",
      link: "/analyze",
    ...
    },
    {
      ...
      title: "Improve",
      description:
        "Use AI to enhance your captions and visuals. Create content that converts.",
      link: "/improve",
    ...
    },
    {
      ...
      title: "Plan",
      description:
        "Schedule and manage your content calendar. Stay consistent effortlessly.",
      link: "/plan",
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at ${mousePosition.x}% ${
              mousePosition.y
            }%, rgba(99, 102, 241, 0.3), transparent 40%),
                        radial-gradient(circle at ${100 - mousePosition.x}% ${
              100 - mousePosition.y
            }%, rgba(168, 85, 247, 0.2), transparent 50%)`,
          }}
        ></div>
        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 pt-20 pb-32">
          ...
          <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
            <div className="w-full h-full max-w-6xl opacity-30">
              <Spline
                scene="https://prod.spline.design/JqEKsF-ZXBeoIp7D/scene.splinecode"
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
                Powerful tools designed for modern creators who want to dominate
                social media
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  {/* Glow effect */}
                  <div
                    className={`absolute -inset-0.5 bg-gradient-to-r ${feature.gradient} rounded-3xl blur-xl opacity-0 group-hover:opacity-30 transition-all duration-500`}
                  ></div>
                  ...
                  <div className="relative h-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl rounded-3xl p-8 border border-white/10 group-hover:border-white/20 transition-all duration-500 cursor-pointer overflow-hidden">
                    ...
                    <div className="relative">
                      <div
                        className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-2xl`}
                      >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Track everything in one beautiful, intuitive interface designed
                for power users
              </p>
            </motion.div>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-10">
                    {[
                      ...
                      >
                        ...
                        <div
                          className={`relative bg-gradient-to-br ${stat.color} p-[1px] rounded-2xl`}
                        >
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              >
                ...
                <p className="text-xl text-gray-400 mb-10 leading-relaxed">
                  Manage Instagram, X (Twitter), LinkedIn, and more from one
                  powerful dashboard. Sync once, manage forever.
                </p>
                ...
                <div className="space-y-5 mb-10">
                  {[
                    {
                      icon: CheckCircle2,
                      text: "One-click social account integration",
                      color: "from-green-400 to-emerald-500",
                    },
                    {
                      icon: CheckCircle2,
                      text: "Real-time analytics tracking across platforms",
                      color: "from-blue-400 to-cyan-500",
                    },
                    {
                      icon: CheckCircle2,
                      text: "Unified audience growth metrics",
                      color: "from-purple-400 to-pink-500",
                    },
                    {
                      icon: CheckCircle2,
                      text: "Cross-platform content scheduling",
                    ...
                    >
                      <div
                        className={`relative w-8 h-8 rounded-full bg-gradient-to-r ${item.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}
                      >
              ...
              >
                {[
                  ...
                  >
                    <div
                      className={`absolute -inset-1 bg-gradient-to-br ${platform.color} rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity`}
                    ></div>

                    <div
                      className={`relative bg-gradient-to-br ${platform.color} rounded-3xl p-8 text-white shadow-2xl`}
                    >
                      <platform.icon
                        size={48}
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-400">
                Join thousands of satisfied users transforming their social
                media
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div
                    className={`absolute -inset-0.5 bg-gradient-to-br ${testimonial.image} rounded-3xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500`}
                  ></div>
                  ...
                  <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl rounded-3xl p-8 border border-white/10 group-hover:border-white/20 transition-all duration-300 h-full">
                    ...
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-14 h-14 rounded-full bg-gradient-to-br ${testimonial.image} flex items-center justify-center text-white font-bold text-lg shadow-lg ring-2 ring-white/10`}
                      >
                        {testimonial.avatar}
                      </div>
                      <div>
                ...
                <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-[2rem] p-12 md:p-16">
                  <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                      Experience the full power of Postwise with our 14-day free
                      trial.
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-blue-900/60 to-purple-900/60 backdrop-blur-3xl rounded-[2.5rem] p-16 md:p-24 border border-white/20 text-center overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  >
                    Join 50,000+ creators who trust Postwise to grow their
        ...
        <footer className="relative border-t border-white/10 bg-black/80 backdrop-blur-xl py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-5 gap-12 mb-16">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-400 mb-6 leading-relaxed">
                  AI-powered social media management for modern creators. Grow
                  smarter, not harder.
                </p>
            ...
            <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
              <p className="text-gray-400 text-sm">
                © 2025 Postwise. Built with ❤️ by{" "}
                <span className="text-white font-semibold">Anshit Puri</span>
              </p>
